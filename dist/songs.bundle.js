...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/postcss-loader/lib/index.js!../../node_modules/sass-loader/lib/loader.js??ref--1-3!./songs.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/postcss-loader/lib/index.js!../../node_modules/sass-loader/lib/loader.js??ref--1-3!./songs.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "@-webkit-keyframes a{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}@keyframes a{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}.page{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;height:100vh;background:transparent no-repeat 50%;background-size:cover}.page,.page>.links{display:-webkit-box;display:-ms-flexbox;display:flex}.page>.links{-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;color:#d43b32}.page>.links>a{width:38.5vw;margin:1em;text-align:center;border:1px solid #d43b32;background:transparent;padding:1.5vw;color:inherit;text-decoration:none;border-radius:1.3vw;letter-spacing:1vw}.page>.links>a.main{background:#d43b32;color:#fff}.disc-container{position:relative}.disc-container .icon-wrapper{position:absolute;top:44vw;left:40vw;z-index:1;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;height:20vw;width:20vw;border-radius:50%;background:rgba(0,0,0,.5)}.disc-container .icon{width:100%;fill:#fff}.disc-container .pointer{width:24vw;position:absolute;left:45vw}.disc-container .disc{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;margin-top:18vw}.disc-container .ring{width:72vw}.disc-container .light{width:72vw;position:absolute;top:18vw;left:14vw}.disc-container .cover{width:44.5vw;position:absolute;top:31.9vw;left:27.75vw;border-radius:50%;-webkit-animation:a 20s infinite linear;animation:a 20s infinite linear;-webkit-animation-play-state:paused;animation-play-state:paused}.disc-container.playing .cover,.disc-container.playing .light{-webkit-animation-play-state:running;animation-play-state:running}.disc-container.playing .icon-pause{display:block}.disc-container .icon-pause,.disc-container.playing .icon-play{display:none}.song-description{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;color:#aeabac;text-align:center;line-height:2;margin-top:20px}.song-description h1{color:#fff;font-size:18px}.song-description p{font-size:14px;line-height:24px}.song-description p.active{color:#fff}.song-description .lines{transition:-webkit-transform .3s;transition:transform .3s;transition:transform .3s,-webkit-transform .3s}.song-description .lyric{height:72px;overflow:hidden}", ""]);
